...
(cl:defmethod cl:initialize-instance :after ((m <RobotCoord>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotCoord)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name navigation_pkg-msg:<RobotCoord> is deprecated: use navigation_pkg-msg:RobotCoord instead.")))
