...
(cl:defmethod cl:initialize-instance :after ((m <EmergencyStop>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EmergencyStop)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ydlidar_ros_driver-msg:<EmergencyStop> is deprecated: use ydlidar_ros_driver-msg:EmergencyStop instead.")))

(cl:ensure-generic-function 'signal-val :lambda-list '(m))
(cl:defmethod signal-val ((m <EmergencyStop>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ydlidar_ros_driver-msg:signal-val is deprecated.  Use ydlidar_ros_driver-msg:signal instead.")
  (signal m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EmergencyStop>)))
  ...
  "ydlidar_ros_driver/EmergencyStop")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EmergencyStop)))
  "Returns string type for a message object of type 'EmergencyStop"
  "ydlidar_ros_driver/EmergencyStop")
