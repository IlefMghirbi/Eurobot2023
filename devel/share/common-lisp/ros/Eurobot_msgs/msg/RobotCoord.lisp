...
(cl:defmethod cl:initialize-instance :after ((m <RobotCoord>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotCoord)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Eurobot_msgs-msg:<RobotCoord> is deprecated: use Eurobot_msgs-msg:RobotCoord instead.")))
