...
echo_and_run cd "/home/ilef/Euro_ws/src/generic_flexbe_states/flexbe_manipulation_states"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ilef/Euro_ws/src/generic_flexbe_states/flexbe_manipulation_states/setup.py" \
     \
    build --build-base "/home/ilef/Euro_ws/build/generic_flexbe_states/flexbe_manipulation_states" \
    install \
    --root="${DESTDIR-/}" \
