...
echo_and_run cd "/home/ilef/Euro_ws/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ilef/Euro_ws/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/ilef/Euro_ws/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
