...
(cl:defmethod cl:initialize-instance :after ((m <EmergencyStop>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EmergencyStop)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Eurobot_msgs-msg:<EmergencyStop> is deprecated: use Eurobot_msgs-msg:EmergencyStop instead.")))

(cl:ensure-generic-function 'signal-val :lambda-list '(m))
(cl:defmethod signal-val ((m <EmergencyStop>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Eurobot_msgs-msg:signal-val is deprecated.  Use Eurobot_msgs-msg:signal instead.")
  (signal m))
