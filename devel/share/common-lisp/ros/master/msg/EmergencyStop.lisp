...
(cl:defmethod cl:initialize-instance :after ((m <EmergencyStop>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EmergencyStop)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name master-msg:<EmergencyStop> is deprecated: use master-msg:EmergencyStop instead.")))

(cl:ensure-generic-function 'signal-val :lambda-list '(m))
(cl:defmethod signal-val ((m <EmergencyStop>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader master-msg:signal-val is deprecated.  Use master-msg:signal instead.")
  (signal m))
