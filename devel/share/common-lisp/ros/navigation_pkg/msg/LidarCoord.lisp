...
(cl:defmethod cl:initialize-instance :after ((m <LidarCoord>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LidarCoord)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name navigation_pkg-msg:<LidarCoord> is deprecated: use navigation_pkg-msg:LidarCoord instead.")))
...
(cl:defmethod theta-val ((m <LidarCoord>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader navigation_pkg-msg:theta-val is deprecated.  Use navigation_pkg-msg:theta instead.")
  (theta m))
