...
(cl:defmethod cl:initialize-instance :after ((m <LidarCoord>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LidarCoord)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Eurobot_msgs-msg:<LidarCoord> is deprecated: use Eurobot_msgs-msg:LidarCoord instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <LidarCoord>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Eurobot_msgs-msg:x-val is deprecated.  Use Eurobot_msgs-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <LidarCoord>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Eurobot_msgs-msg:y-val is deprecated.  Use Eurobot_msgs-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <LidarCoord>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Eurobot_msgs-msg:theta-val is deprecated.  Use Eurobot_msgs-msg:theta instead.")
  (theta m))
