...
echo_and_run cd "/home/ilef/Euro_ws/src/robot_state_machine_behaviors/robot_state_machine_flexbe_behaviors"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ilef/Euro_ws/src/robot_state_machine_behaviors/robot_state_machine_flexbe_behaviors/setup.py" \
     \
    build --build-base "/home/ilef/Euro_ws/build/robot_state_machine_behaviors/robot_state_machine_flexbe_behaviors" \
    install \
    --root="${DESTDIR-/}" \
